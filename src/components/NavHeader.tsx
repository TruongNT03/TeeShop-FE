      ...
      <AnimatePresence>
        {isOpenMenu && (
          ...
          >
              ...
              className="h-full w-[75%] fixed bg-white dark:bg-card p-5"
            >
              ...
              {!isMobile && (
                <div className="flex gap-[20px] ml-8">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-white dark:bg-popover border border-border shadow-lg rounded-lg p-2 text-sm max-h-[500px] overflow-y-auto">
                        ...
                        {accessToken ? (
                          ...
                          cartSummaryData.cartItems.length > 0 ? (
                            <>
                              {cartSummaryData.cartItems
                                ...
                                .map((cartItem) => (
                                  <Link
                                    ...
                                    className="px-3 py-2 rounded-md hover:bg-slate-100 dark:hover:bg-input/20 transition-colors flex items-start gap-3 text-muted-foreground hover:text-foreground"
                                  >
                              ...
                              {cartSummaryData.totalItems > 5 ? (
                                <>
                                  <div className="h-px bg-slate-200 dark:bg-border my-1"></div>
                                  <Link
                                    to="/cart"
                                    className="px-3 py-2 rounded-md hover:bg-slate-100 dark:hover:bg-input/20 transition-colors flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground text-xs font-medium"
                                  >
                                    Xem thêm
                                  </Link>
                                </>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link to="/profile">
                          ...
                          <TooltipContent className="bg-white dark:bg-popover border border-border shadow-lg rounded-lg p-2 text-sm">
                        <div className="flex flex-col min-w-[200px] gap-1">
                          <Link
                            to="/profile/info"
                            className="px-3 py-2 rounded-md hover:bg-slate-100 dark:hover:bg-input/20 transition-colors flex items-center gap-2 text-muted-foreground hover:text-foreground"
                          >
                          ...
                          <div
                            ...
                            className="px-3 py-2 rounded-md hover:bg-slate-100 dark:hover:bg-input/20 transition-colors flex items-center gap-2 text-muted-foreground hover:text-foreground cursor-pointer"
                          >
                            {theme === "dark" ? (
                              <>
